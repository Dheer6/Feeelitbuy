...
export function Home({ onNavigate, onCategoryClick, onViewProduct, products, onAddToCart }: HomeProps) {
  ...
  // Categories
  const categories = [
    { id: 'smartphones', name: 'Smartphones', icon: Smartphone, color: 'bg-red-500', count: '500+' },
    { id: 'laptops', name: 'Laptops', icon: Laptop, color: 'bg-red-500', count: '300+' },
  ...
  const brands = [
    ...
    { name: 'Godrej', logo: 'https://1000logos.net/wp-content/uploads/2021/04/Godrej-logo.png' },
    { name: 'Nilkamal', logo: 'https://www.nilkamal.com/images/logo.png' },
    { name: 'Durian', logo: 'https://www.durian.in/themes/custom/durian/logo.svg' }
  ];
    ...
    <Root.div>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-in slide-in-from-right duration-700">
                <div className="relative z-10 overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-br from-gray-50 to-gray-100 p-4">
                  {/* Auto-sliding product carousel */}
                  <div className="relative h-[400px]">
                    {featuredProducts.slice(0, 6).map((product, index) => (
                      <div
                        key={product.id}
                        className={`absolute inset-0 transition-all duration-700 ease-in-out ${index === currentHeroSlide % 6 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full'
                          }`}
                        style={{
                          transform: index === currentHeroSlide % 6 ? 'translateX(0)' :
                            index < currentHeroSlide % 6 ? 'translateX(-100%)' : 'translateX(100%)'
                        }}
                      >
                        <Card
                        ...
                        >
                          ...
                          <div className="p-6">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                              <span className="text-3xl font-bold text-indigo-600">{formatINR(product.price)}</span>
                              {product.originalPrice && product.originalPrice > product.price && (
                    ...
                    <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2 z-10">
                      {featuredProducts.slice(0, 6).map((_, index) => (
                        <div
                          key={index}
                          className={`w-2 h-2 rounded-full transition-all duration-300 ${index === currentHeroSlide % 6 ? 'bg-indigo-600 w-6' : 'bg-gray-400'
                            }`}
                        />
                      ))}
                    </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-l font-bold text-gray-900 mb-3">Trusted Brands</h2>
            ...
            <div className="relative overflow-hidden">
              <div className="flex animate-scroll gap-12 items-center">
                {[...brands, ...brands].map((brand, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 w-40 h-24 bg-white rounded-lg shadow-md flex items-center justify-center p-4 grayscale hover:grayscale-0 transition-all duration-300 hover:scale-110 cursor-pointer"
                  >
                    <img
                      src={brand.logo}
                      alt={brand.name}
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.innerHTML = `<span class="text-xl font-bold text-gray-700">${brand.name}</span>`;
                        }
                      }}
                    />
                  </div>
